      ...
      <section className="py-10 px-5 relative">
        <div className="max-w-[1280px] mx-auto">
          <motion.a
            ...
            style={{ background: 'rgba(7,14,30,0.90)' }}
          >
            {/* MOBILE: imagem completa + conteúdo abaixo */}
            <div className="lg:hidden">
              ...
              />
              <div className="p-5">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-amber-400/30 bg-amber-400/[0.10] mb-3">
                ...
                <div className="flex flex-wrap gap-1.5 mb-4">
                  {['SOI e HAM', 'Medicina', '1° e 2° Períodos', 'OSCE', 'N1', 'Multiestação'].map((tag) => (
                    <span key={tag} className="px-2 py-0.5 rounded-md text-[11px] font-semibold text-teal-300 border border-teal-400/20 bg-teal-400/[0.07]">
                      {tag}
                    </span>
                  ))}
                </div>
                <div
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold text-[#040816]"
                  style={{ background: 'linear-gradient(135deg, #4ADE80 0%, #2DD4BF 100%)' }}
                >
            ...
            {/* DESKTOP: imagem na proporção 2073×758, conteúdo sobreposto à direita */}
            <div className="hidden lg:block relative" style={{ aspectRatio: '2073/758' }}>
              ...
              <div className="absolute inset-0 pointer-events-none"
                style={{ background: 'linear-gradient(to right, transparent 35%, rgba(4,8,22,0.90) 100%)' }}
              />
              <div className="absolute inset-0 pointer-events-none"
                style={{ background: 'linear-gradient(to top, rgba(4,8,22,0.60) 0%, transparent 60%)' }}
              />
              <div className="absolute inset-0 flex items-center justify-end p-10">
                <div className="w-[42%]">
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-amber-400/30 bg-black/40 backdrop-blur-sm mb-4">
                    <span className="w-1.5 h-1.5 rounded-full bg-amber-400" />
                    <span className="text-[10px] font-bold text-amber-300 uppercase tracking-wide">Parceria Exclusiva</span>
                  </div>
                  <h3 className="text-[1.75rem] font-bold text-white mb-2 leading-tight drop-shadow-lg">
                    Resumos da Giulia Modesto
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-5">
                    {['SOI e HAM', 'Medicina', '1° e 2° Períodos', 'OSCE', 'N1', 'Multiestação'].map((tag) => (
                      <span key={tag} className="px-2 py-0.5 rounded-md text-[11px] font-semibold text-teal-200 border border-teal-400/25 bg-black/35 backdrop-blur-sm">
                        {tag}
                      </span>
                    ))}
                  </div>
          ...
          >
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center gap-2.5 rounded-2xl border border-white/[0.10] bg-white/[0.04] px-4 py-3.5 text-sm font-semibold text-slate-200 backdrop-blur-md transition-all hover:-translate-y-0.5 hover:border-[#25D366]/40 hover:bg-white/[0.08] hover:shadow-[0_0_24px_rgba(37,211,102,0.25)]"
              >
                <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-[#25D366] to-[#128C7E] text-white shadow-lg shadow-[#25D366]/30 transition-transform group-hover:scale-110">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center gap-2.5 rounded-2xl border border-white/[0.10] bg-white/[0.04] px-4 py-3.5 text-sm font-semibold text-slate-200 backdrop-blur-md transition-all hover:-translate-y-0.5 hover:border-[#E4405F]/40 hover:bg-white/[0.08] hover:shadow-[0_0_24px_rgba(228,64,95,0.25)]"
              >
                <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-[#833AB4] via-[#E4405F] to-[#FCAF45] text-white shadow-lg shadow-[#E4405F]/30 transition-transform group-hover:scale-110">
              ...
              <a
                ...
                className="group flex items-center justify-center gap-2.5 rounded-2xl border border-white/[0.10] bg-white/[0.04] px-4 py-3.5 text-sm font-semibold text-slate-200 backdrop-blur-md transition-all hover:-translate-y-0.5 hover:border-teal-400/40 hover:bg-white/[0.08] hover:shadow-[0_0_24px_rgba(45,212,191,0.25)]"
              >
                <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-[#4ADE80] to-[#2DD4BF] text-[#040816] shadow-lg shadow-[#2DD4BF]/30 transition-transform group-hover:scale-110">
