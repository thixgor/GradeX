  ...
  return (
    <div className={cn('w-full max-w-2xl lg:max-w-4xl mx-auto', className)}>
      ...
      <div className="relative w-full [perspective:1100px] sm:[perspective:1500px] lg:[perspective:2200px]">
        {/* Empilhamento em CSS grid: as duas faces ocupam a MESMA célula
            (grid-area 1/1), então o card assume sempre a altura da face mais
            alta e NUNCA muda de tamanho ao virar — sem medição por JS. */}
        <motion.div
        ...
        >
          ...
          <div
            onClick={onFlip}
            className={cn(
              '[grid-area:1/1] relative overflow-hidden rounded-3xl p-4 sm:p-7 md:p-9 lg:p-12 min-h-[300px] sm:min-h-[320px] md:min-h-[380px] lg:min-h-[500px] flex flex-col cursor-pointer select-none',
          ...
          >
            ...
            {/* Brilho ambiente sutil no canto — profundidade + toque da marca */}
            <div aria-hidden className="pointer-events-none absolute -right-24 -top-24 -z-10 h-64 w-64 rounded-full bg-emerald-400/10 blur-3xl dark:bg-emerald-500/10" />
          ...
          <div
            onClick={onFlip}
            className={cn(
              '[grid-area:1/1] relative rounded-3xl p-4 sm:p-7 md:p-9 lg:p-12 min-h-[300px] sm:min-h-[320px] md:min-h-[380px] lg:min-h-[500px] flex flex-col cursor-pointer select-none overflow-hidden',
          ...
          >
            ...
            {/* Brilho âmbar quente no canto — realça a profundidade no verso */}
            <div aria-hidden className="pointer-events-none absolute -right-24 -top-24 -z-10 h-64 w-64 rounded-full bg-amber-300/20 blur-3xl" />
            <div aria-hidden className="pointer-events-none absolute -bottom-28 -left-20 -z-10 h-72 w-72 rounded-full bg-emerald-400/15 blur-3xl" />
            <div className="flex items-center justify-between mb-3">
