...
37. ✅ **RTS, ISS/AIS e TRISS** — gravidade fisiológica e anatômica do trauma e probabilidade de sobrevida. `trauma-rts-iss` entrega RTS ponderado, RTS de triagem, ISS pelos seis segmentos AIS e **TRISS completo**: coeficientes da MTOS (Boyd 1987) por mecanismo — contuso b₀ −0,4499 / b₁ 0,8085 / b₂ −0,0835 / b₃ −1,7430; penetrante b₀ −2,5355 / b₁ 0,9934 / b₂ −0,0651 / b₃ −1,1360 —, índice de idade binário em 55 anos e regra de usar coeficientes de contuso abaixo de 15 anos. Coeficientes conferidos em consultas independentes e a aritmética validada em casos de referência. **[P1]**
...
197. **SCORTEN e ALDEN** — mortalidade na necrólise epidérmica tóxica e causalidade medicamentosa. **[P1]**
    - 🟡 **parcial** — `scorten` feito, com o ALDEN descrito na conduta; o ALDEN como calculadora própria fica pendente
