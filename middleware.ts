...
const publicRoutes = [
  ...
  // ainda não tem conta.
  '/api/coupons/promo',
  // Catálogo de cargos (nome, cor, o que cada um abre). É a mesma informação
  // que a página de planos publica, e as telas de compra sem login precisam
  // dela para nomear o que está sendo vendido.
  '/api/cargos',
