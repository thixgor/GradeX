...
export const GLOSSARIO: Record<string, string[]> = {
  ...
  amigdala: ['orofaringe'],
  nariz: ['rinoscopia'],
  pupila: ['pupilas', 'anisocoria', 'adie', 'horner', 'leucocoria'],
  ...
  'pe torto': ['equinovaro'],
  clubfoot: ['pe torto'],
  bloqueio: ['bloqueios', 'nervo', 'anestesia'],
  'nerve block': ['bloqueios'],
  peng: ['pericapsular', 'quadril'],
  tap: ['transverso do abdome'],
  'fascia iliaca': ['fascia iliaca', 'quadril'],
  microscopia: ['sedimento', 'gram', 'koh', 'gota espessa'],
  malaria: ['gota espessa', 'plasmodium'],
  urina: ['sedimento', 'cilindros', 'cristais'],
  wood: ['luz de wood', 'fluorescencia'],
  capilaroscopia: ['capilaroscopia', 'esclerodermia'],
  raynaud: ['capilaroscopia', 'esclerodactilia'],
  marcha: ['marcha', 'ceifante', 'escarvante', 'anserina', 'talonante', 'magnetica', 'antalgica'],
  gait: ['marcha'],
  coreia: ['sydenham', 'huntington', 'hemibalismo'],
  chorea: ['coreia'],
  tremor: ['tremor essencial', 'tremor de repouso', 'asterixe'],
  convulsao: ['crise tonico-clonica', 'crise de ausencia'],
  seizure: ['crise tonico-clonica', 'crise de ausencia'],
  epilepsia: ['crise tonico-clonica', 'crise de ausencia'],
  vertigem: ['dix-hallpike', 'hints', 'nistagmo'],
  tontura: ['dix-hallpike', 'hints', 'nistagmo'],
  miastenia: ['ptose fatigavel'],
  duchenne: ['gowers', 'pseudo-hipertrofia'],
  tiroide: ['nodulo tireoidiano', 'tireoidite'],
  tireoide: ['nodulo tireoidiano', 'tireoidite'],
  mama: ['mama', 'paget', 'peau d orange'],
  carotida: ['carotida', 'placa carotidea', 'estenose carotidea'],
  placenta: ['placenta previa', 'descolamento'],
  hernia: ['hernia inguinal', 'hernia incisional', 'hernia umbilical', 'hernia femoral', 'hernia epigastrica', 'spiegel', 'eventracao', 'hidrocele'],
  estomia: ['estomas'],
  colostomia: ['estomas'],
  ileostomia: ['estomas'],
  hemorroida: ['hemorroida trombosada', 'fissura anal', 'prolapso retal'],
  micose: ['tinha', 'onicomicose', 'candidiase', 'versicolor'],
  fungo: ['tinha', 'onicomicose', 'koh'],
  piolho: ['pediculose'],
  verruga: ['verruga vulgar', 'condiloma'],
  hpv: ['condiloma', 'verruga'],
  herpes: ['herpes labial', 'herpes genital', 'herpes zoster'],
  espinha: ['acne'],
  cravo: ['acne'],
  cicatriz: ['queloide'],
  vergao: ['dermografismo', 'urticaria'],
  neurofibromatose: ['cafe-com-leite', 'neurofibromas'],
  'cafe com leite': ['neurofibromatose'],
  hemangioma: ['hemangioma infantil', 'morango'],
  'labio leporino': ['fenda labiopalatina'],
  fenda: ['fenda labiopalatina'],
  hidrocefalia: ['macrocrania', 'sol poente'],
  microcefalia: ['zika'],
  zika: ['microcefalia'],
  ludwig: ['angina de ludwig', 'assoalho da boca'],
  escrofula: ['tuberculose ganglionar'],
  fratura: ['fratura exposta', 'fratura de clavicula', 'colles'],
  luxacao: ['luxacao de dedo', 'luxacao de ombro'],
  tendao: ['popeye', 'thompson', 'dedo em martelo', 'tendinite calcaria', 'manguito'],
  ombro: ['manguito rotador', 'luxacao de ombro', 'tendinite calcaria'],
  joelho: ['osgood', 'bursite', 'artrocentese', 'tendao patelar', 'derrame'],
  punho: ['cisto sinovial', 'tunel do carpo', 'sinovite de punho'],
  // Quinta leva
  unha: ['muehrcke', 'lindsay', 'onicolise', 'vidro de relogio', 'melanoma subungueal', 'baqueteamento'],
  cabelo: ['tricotilomania', 'alopecia androgenetica', 'efluvio telogeno', 'calvicie'],
  boca: ['koplik', 'peteqias do palato', 'abscesso periodontal', 'abscesso peritonsilar', 'sialolitiase', 'lingua em framboesa', 'lingua saburrosa', 'anquiloglossia', 'ranula', 'mucocele'],
  olho: ['conjuntivite', 'episclerite', 'esclerite', 'pinguecula', 'pterigio', 'leucocoria', 'buftalmo', 'coloboma', 'heterocromia', 'adie', 'anisocoria', 'dermatocalase', 'triquiase', 'tracoma', 'ptose'],
  pinta: ['nevo melanocitico', 'lentigo solar', 'ceratose seborreica', 'melanoma'],
  caroco: ['lipoma', 'cisto epidermico', 'linfonodo', 'hernia', 'nodulo'],
  coceira: ['escabiose', 'prurigo', 'eczema disidrotico', 'dermatite herpetiforme', 'urticaria', 'ceratose pilar'],
  brotoeja: ['miliaria'],
  assadura: ['dermatite das fraldas', 'intertrigo'],
  neonatal: ['eritema toxico', 'milium', 'acne neonatal', 'caput', 'cefalo-hematoma', 'ictericia neonatal', 'onfalite', 'granuloma umbilical', 'onfalocele', 'gastrosquise', 'mielomeningocele', 'anquiloglossia'],
  bebe: ['eritema toxico', 'milium', 'dermatite das fraldas', 'plagiocefalia', 'displasia do quadril', 'criptorquidia', 'hidrocele', 'craniotabes', 'raquitismo'],
  quadril: ['displasia do quadril', 'ortolani', 'galeazzi', 'assimetria de pregas'],
  raquitismo: ['craniotabes', 'punhos alargados', 'rosario raquitico', 'sulco de harrison'],
  desnutricao: ['marasmo', 'kwashiorkor'],
  sindrome: ['prader-willi', 'edwards', 'patau', 'noonan', 'klinefelter', 'down', 'turner', 'marfan'],
  trissomia: ['edwards', 'patau', 'down'],
  exantema: ['exantema subito', 'roseola', 'rubeola', 'sarampo', 'escarlatina', 'eritema infeccioso'],
  coluna: ['escoliose', 'adams', 'cifose', 'scheuermann', 'hemivertebra', 'giba'],
  escoliose: ['adams', 'giba', 'hemivertebra', 'escoliose congenita'],
  escroto: ['varicocele', 'hidrocele', 'criptorquidia', 'torcao testicular', 'transiluminacao'],
  penis: ['priapismo', 'fimose', 'parafimose', 'balanite'],
  prolapso: ['prolapso uterino', 'cistocele', 'prolapso retal', 'hemorroidas'],
  artrite: ['artrite septica', 'mao reumatoide', 'artrite mutilante', 'bouchard', 'heberden', 'sinovite', 'derrame articular'],
  reumatoide: ['mao reumatoide', 'desvio ulnar', 'pescoco de cisne', 'botoeira', 'sinovite de punho'],
  calcanhar: ['haglund', 'fasciite plantar', 'esporao'],
  cotovelo: ['luxacao de cotovelo', 'pronacao dolorosa', 'epicondilite', 'bursite'],
  patela: ['luxacao de patela', 'apreensao', 'tecla', 'derrame articular'],
  hemofilia: ['hemartrose', 'artropatia hemofilica'],
  osteomielite: ['fistula', 'sequestro', 'osteomielite cronica'],
  amputacao: ['coto de amputacao', 'dor fantasma', 'neuroma'],
  plexo: ['erb', 'mao de garcom', 'klumpke'],
  atrofia: ['atrofia interossea', 'mao esqueletica', 'atrofia tenar', 'ela'],
  demencia: ['desenho do relogio', 'negligencia', 'mini-cog'],
  negligencia: ['desenho do relogio', 'heminegligencia', 'bisseccao'],
  miotonia: ['facies miotonica', 'steinert', 'distrofia miotonica'],
  distrofia: ['facies miopatica', 'facies miotonica', 'fascio-escapulo-umeral', 'duchenne', 'steinert'],
  linfonodo: ['virchow', 'linfonodomegalia', 'escrofula'],
  virchow: ['linfonodo de virchow', 'supraclavicular', 'troisier'],
  facies: ['facies hipocratica', 'facies miopatica', 'facies miotonica', 'facies leonina', 'acromegalia', 'cushing'],
  purpura: ['purpura senil', 'vasculite leucocitoclastica', 'peteqias'],
  polidactilia: ['sindactilia', 'dedo extranumerario'],
  malformacao: ['polidactilia', 'sindactilia', 'onfalocele', 'gastrosquise', 'mielomeningocele', 'fenda labiopalatina', 'coloboma'],
}
