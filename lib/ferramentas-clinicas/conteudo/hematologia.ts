...
const classificacaoAnemias: Ferramenta = {
  ...
  fundamento:
    'A classificação morfológica pelo VCM sobrevive porque é eficiente: com um único número, o diferencial da anemia se reduz de dezenas de causas a três grupos. O RDW acrescenta uma segunda dimensão — a heterogeneidade —, e é o que separa dentro de cada grupo o que é carencial (populações mistas de hemácias, RDW alto) do que é constitucional ou de doença crônica (população homogênea, RDW normal). A classificação pelo volume corpuscular médio funciona porque o tamanho da hemácia revela em qual etapa da eritropoese o defeito ocorreu. Faltando **ferro, globina ou protoporfirina**, a síntese de hemoglobina é insuficiente e o eritroblasto faz divisões adicionais tentando concentrar o conteúdo — resultando em célula pequena e hipocrômica. Faltando **vitamina B12 ou folato**, a síntese de DNA trava enquanto a do citoplasma prossegue, gerando assincronia núcleo-citoplasma e célula grande. Sem defeito de maturação, o tamanho é normal e a pergunta passa a ser de produção contra destruição — que é o que os reticulócitos respondem.',
  armadilhas: [
...
const isth: Ferramenta = {
  ...
  fundamento:
    'A CIVD é a ativação sistêmica e desregulada da coagulação, com consumo simultâneo de plaquetas e fatores. O escore mede as quatro consequências laboratoriais desse consumo: plaquetas caem, produtos de degradação de fibrina sobem, o tempo de protrombina alarga e o fibrinogênio cai. A exigência de uma condição de base é deliberada — sem gatilho, não há CIVD, e a especificidade despencaria. A CIVD é uma ativação sistêmica e descontrolada da coagulação, geralmente deflagrada pela exposição maciça de **fator tecidual** — pelo endotélio ativado por citocinas na sepse, pelo tecido lesado no trauma, pelas células tumorais, ou pela placenta. A geração difusa de trombina consome fatores e plaquetas, deposita fibrina na microcirculação (produzindo isquemia de órgãos e esquizócitos pela fragmentação mecânica das hemácias) e ativa secundariamente a fibrinólise, elevando os produtos de degradação. Os quatro itens do escore medem exatamente essas quatro consequências.',
  armadilhas: [
...
const ganzoni: Ferramenta = {
  ...
  fundamento:
    'O fator 2,4 vem da aritmética do ferro corporal: o volume sanguíneo é cerca de 7% do peso (70 mL/kg), e cada grama de hemoglobina contém 3,4 mg de ferro. Multiplicando 0,07 dL/kg por 3,4 mg/g e por 10 (conversão de unidades), chega-se a 2,4. O termo de reserva existe porque corrigir só a hemoglobina deixa o estoque vazio e a anemia recidiva. A fórmula existe porque repor apenas o ferro necessário para corrigir a hemoglobina deixa o **estoque vazio**, e o paciente recidiva em meses. Por isso ela soma duas parcelas: o déficit de ferro incorporado à hemoglobina — calculado a partir do peso, da diferença entre hemoglobina-alvo e atual, e do conteúdo de 3,4 mg de ferro por grama de hemoglobina em cerca de 70 mL de sangue por quilo — e um acréscimo fixo de 500 mg destinado a reconstituir os depósitos de ferritina no sistema reticuloendotelial.',
  armadilhas: [
