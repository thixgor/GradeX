...
import { FaixaVendaCompacta } from '@/components/ferramentas-clinicas/vitrine'
...
function Conteudo() {
  ...
  // A área é aberta; o acesso só decide se a faixa de assinatura aparece no
  // rodapé, e por isso não segura a renderização das ferramentas.
