...
export const metadata: Metadata = {
  ...
  description:
    '201 calculadoras e escores clínicos interativos, com a conta aberta, interpretação do resultado, fundamento fisiológico, armadilhas de aplicação e referência bibliográfica. Gasometria, cardiologia, ventilação mecânica, nefrologia, sepse, neurologia, hepatologia, hematologia, endocrinologia, pediatria, obstetrícia, emergência, cirurgia, farmacologia e nutrição. Três liberadas para testar sem cadastro.',
  robots: publicIndexingRobots,
  openGraph: {
    title: 'Ferramentas Clínicas — calculadoras e escores interativos',
    description:
      'Winter, ânion gap corrigido, delta-delta, driving pressure, CKD-EPI, SOFA, NIHSS, MELD, CHA₂DS₂-VASc, Holliday-Segar, conversão de opioides e mais 190 outras — cada uma com fórmula, interpretação e referência. Experimente três de graça.',
  },
}
