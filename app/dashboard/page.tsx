  ...
  async function loadUserData() {
    try {
      ...
      if (res.ok) {
        ...
        setUserStats(prev => ({
          ...prev,
          cronogramasCreated: data.user?.totalCronogramasCreated || 0,
          flashcardsCreated: data.user?.totalFlashcardsCreated || 0,
          personalExamsCreated: data.user?.totalPersonalExamsCreated || 0,
        }))
      }
    } catch (error) {
