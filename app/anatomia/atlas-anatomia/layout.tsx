...
const descricao = `Explore ${ATLAS_TOTALS.pieces} pranchas anatômicas reais do acervo em ${ATLAS_SYSTEMS.length} sistemas, com ${ATLAS_TOTALS.markers.toLocaleString('pt-BR')} estruturas marcadas: localização, função, vascularização, inervação e correlação clínica de cada uma.`
