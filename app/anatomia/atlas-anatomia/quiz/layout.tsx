...
const descricao = `Treine identificação de estruturas em pranchas reais do acervo: o marcador aparece sem rótulo e você diz qual é. Cada resposta vem comentada, com o raciocínio de identificação e o porquê de cada alternativa. ${ATLAS_TOTALS.markers.toLocaleString('pt-BR')} estruturas sorteáveis.`
