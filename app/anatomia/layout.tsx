...
const descricao = `Estude anatomia em ${ATLAS_TOTALS.pieces} pranchas do Atlas, com ${ATLAS_TOTALS.markers.toLocaleString('pt-BR')} estruturas marcadas e detalhadas (localização, função, vascularização, inervação e clínica), ou explore ${TOTAL_MODELOS} modelos anatômicos rotacionáveis em 360°.`
