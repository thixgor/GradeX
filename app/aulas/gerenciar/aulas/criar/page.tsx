        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-white">Criar Aula</h1>
              </div>
            </div>
            <ThemeToggle />
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-6">
            ...
            <div className="space-y-4">
              ...
              {tipo === 'gravada' && (
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Cole o código embed do vídeo ou URL"
                    className="mt-1 bg-white/5 border-white/10 text-white placeholder:text-white/40"
                    rows={4}
                  />
                </div>
              ...
              <div>
                <Label className="text-white/80">Materiais de Apoio (PDFs - Máx 3, até 2MB cada)</Label>
                <div className="border-2 border-dashed border-white/20 rounded-lg p-6 text-center cursor-pointer hover:bg-white/5 transition-colors mt-2">
                  <input
                    type="file"
                    multiple
                    accept=".pdf"
                  ...
                  <label htmlFor="pdf-upload" className="cursor-pointer">
                    ...
                    <p className="text-sm font-medium text-white">Clique para fazer upload de PDFs</p>
                    <p className="text-xs text-white/40">ou arraste arquivos aqui</p>
                  </label>
                </div>
                    ...
                    {pdfs.map((pdf, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-white/5 border border-white/10 rounded-lg">
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-white truncate">{pdf.nome}</p>
