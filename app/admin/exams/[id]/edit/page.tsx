          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              {examData.isPracticeExam && (
                <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <p className="text-sm text-blue-900 dark:text-blue-100">
                    <strong>Modo Prova Prática ativado:</strong> As datas de início/fim e portões são opcionais. A prova ficará disponível permanentemente e os alunos poderão fazer múltiplas tentativas.
                  </p>
                </div>
              )}
              ...
              <div className="space-y-3 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <div>
                  <Label htmlFor="timeMode" className="font-semibold">Tempo Máximo por Questão</Label>
                  <select
                    id="timeMode"
                  ...
                  >
                    ...
                    <option value="generalized">Tempo generalizado (mesmo tempo para todas)</option>
                ...
                {examData.timeMode === 'generalized' && (
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-orange-600 dark:text-orange-400">
                      Quando o tempo de uma questão acabar, ela será enviada automaticamente e o aluno passará para a próxima.
                    </p>
                  </div>
                )}
                      ...
                      <div className="space-y-3 pl-7">
                            ...
                            <div className="flex gap-3">
                              ...
                              <label className="flex items-center space-x-2 cursor-pointer">
                                <input
                                  ...
                                  className="h-4 w-4"
                                />
                                <span className="text-sm">Tela Inteira</span>
                              </label>
                            </div>
                          </div>
                        )}
                        ...
                        {examData.proctoringCamera && (
                          <div className="p-3 bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded text-xs">
                            <p className="font-semibold text-yellow-900 dark:text-yellow-100">Segurança Automática:</p>
                        ...
                        {(examData.proctoringCamera || examData.proctoringAudio || examData.proctoringScreen) && (
                          <div className="p-3 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded text-xs">
                            <p className="font-semibold text-blue-900 dark:text-blue-100">Resumo:</p>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label>Tempo Máximo por Questão (opcional)</Label>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {currentQuestion.timePerQuestionSeconds ? (
                      <>
                        Quando o tempo acabar, a questão será enviada automaticamente com a resposta atual.
                  ...
                  <div className="space-y-3">
                    ...
                    {currentQuestion.alternativeType && currentQuestion.alternativeType !== 'standard' && (
                      <p className="text-xs text-muted-foreground bg-blue-50 dark:bg-blue-950 p-2 rounded">
                        As alternativas para este tipo de questão são pré-definidas. Apenas marque a alternativa correta.
                      </p>
                    )}
